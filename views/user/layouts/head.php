...
while ($row = $results->fetch_assoc()) { ?>
  ...
  <?php
  $headarr[$row['name']] = $row;

}
?>
<meta property="og:title" content="<?php echo $headarr['title']['content'] ?>" />
<meta property="og:description" content="<?php echo $headarr['description']['content'] ?>" />
<meta property="og:image" content="<?php echo $site_url . $headarr['image_url']['content'] ?>" />
<meta property="og:url" content="<?php echo $site_url ?>" />

<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:image" content="<?php echo $site_url . $headarr['image_url']['content'] ?>">
<meta name="twitter:title" content="<?php echo $headarr['title']['content'] ?>">
<meta name="twitter:description" content="<?php echo $headarr['description']['content'] ?>">
